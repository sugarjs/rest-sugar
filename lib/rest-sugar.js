...
function initAPI(app, name, model, queries, auth, success) {
    ...
    var groupOps = {
        post: function(req, res) {
            queries.create(model, getParams(req), operator(res));
        },
        get: function(req, res) {
            ...
            else queries.getAll(model, query, operator(res));
        },
        'delete': function(req, res) {
            queries['delete'](model, req.body._id, operator(res));
        }
    };
    ...
    app.get(name + '/count', handle(auth, function(req, res) {
        queries.count(model, operator(res));
    }));
    ...
    var idOps = {
        get: function(req, res) {
            ...
            else queries.get(model, req.params.id, req.query.fields, operator(res));
        },
        put: function(req, res) {
            queries.update(model, req.params.id, getParams(req), operator(res));
        },
        'delete': function(req, res) {
            queries['delete'](model, req.params.id, operator(res));
        }
    };
