...
function initAPI(app, name, model, queries, auth) {
    ...
    var idOps = {
        get: function(req, res) {
            ...
            else queries.get(model, getId(req.params), req.query.fields, ret(res));
        },
        put: function(req, res) {
            queries.update(model, getId(req.params), getParams(req), ret(res));
        },
        'delete': function(req, res) {
            queries['delete'](model, getId(req.params), ret(res));
        }
    };
